...
import memory_cost_profiler as M26
try:
...
if __name__ == '__main__':
    model = main()
    memory_cost, params = M26.profile_memory_cost(model, input_size=(1, 3, 224, 224), require_backward=True, activation_bits=32, trainable_param_bits=32, frozen_param_bits=8, batch_size=1)
    print(f'Memory Cost {memory_cost} // {params}')