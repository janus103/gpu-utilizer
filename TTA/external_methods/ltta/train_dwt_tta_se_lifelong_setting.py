    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            if args.model.startswith('vgg') or args.model.startswith('mobile'):
                ...
                model(input, dwt_ratio=target_dwt, ena_dwt_ratio=args.ena_dwt_ratio, dwt_quant=args.dwt_quant, dwt_drop=args.drop_low, is_weight = args.weight_net, is_test=True)
