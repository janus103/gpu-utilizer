...
def auxiliary_argument_policy(magitude_list, hparams=None):
    policy = [
        #[
            ('Brightness', 0.75, magitude_list[0]), #1
            ('Contrast', 0.75, magitude_list[1]),  
            ('Color', 0.75, magitude_list[2]),
            ('Sharpness', 0.75, magitude_list[3]),
            ('AutoContrast', 0.5, magitude_list[4]),
            ('Invert', 0.5, magitude_list[5]),
            ('Equalize', 0.5, magitude_list[6]),
            ('Solarize', 0.75, magitude_list[7]),
            ('SolarizeAdd', 0.75, magitude_list[8]),
            ('Posterize', 0.75, magitude_list[9]), 
            ('SaltNoise', 0.75, magitude_list[10]),
            ('GaussianNoise', 0.75, magitude_list[11]),
            ('ShearX', 0.75, magitude_list[12]),
            ('ShearY', 0.75, magitude_list[13]),
            ('Rotate', 0.75, magitude_list[14]),
            ('FlipAux', 0.5, magitude_list[15]) #10
        #]
    ]
