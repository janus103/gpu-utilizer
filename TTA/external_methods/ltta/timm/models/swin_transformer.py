...
class SwinTransformer(nn.Module):
    ...
    def __init__(
            ...
            no_skip=False, aux_header=False, dwt_kernel_size=[0,0,0], dwt_level=[0,0,0], dwt_bn=[0,0,0], deep_format=False, **kwargs):
        super().__init__()
        ...
        self.patch_embed = PatchEmbed(
            ...
            no_skip=no_skip, aux_header=aux_header, dwt_kernel_size=dwt_kernel_size, dwt_level=dwt_level, dwt_bn=dwt_bn, deep_format=deep_format)
    ...
    def get_nll_loss(self):
        return self.patch_embed.get_nll_loss()
...
@register_model
def swin_base_patch4_window7_224_in22k_dwt_se(pretrained=False, aux_header=False, no_skip=False, dwt_kernel_size=[0, 0, 0], dwt_level=[2, 2, 2], dwt_bn=[0, 0, 0], deep_format=False, mvar=False, meta_option=0, **kwargs):
    """ Swin-B @ 224x224, trained ImageNet-22k
    """
    print(f'LOG_CHECKER = SWIN 2 -? {dwt_kernel_size} {dwt_level} {dwt_bn}')

    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32),
         aux_header=aux_header, no_skip=no_skip, dwt_kernel_size=dwt_kernel_size, dwt_level=dwt_level, dwt_bn=dwt_bn, deep_format=False, mvar=mvar, meta_option=0, **kwargs)
    return _create_swin_transformer('swin_base_patch4_window7_224_in22k', pretrained=pretrained, **model_kwargs)
