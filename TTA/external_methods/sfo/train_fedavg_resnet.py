#!/usr/bin/env python3
"""FedAvg Training — ResNet with Parallel Channel/Spatial Attention

Federated Averaging over 15 ImageNet-C corruption clients for ResNet models.
Trains the Parallel Channel/Spatial Attention modules placed after conv1
(apply_early path in ResNet).
...
_logger = logging.getLogger('fedavg_resnet')
